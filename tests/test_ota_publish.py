...
[tool.scistudio.ota]
manifest_url = "https://github.com/jiazhenz026/scistudio-package-lcms/releases/download/ota-alpha/manifest.json"
channel = "alpha"
min_core_base = "0.2.1"
"""
...
def test_read_ota_config():
    ...
    assert config["name"] == "scistudio-package-lcms"
...
def test_parse_manifest_url():
    repo, tag = ota_publish.parse_manifest_url(
        "https://github.com/jiazhenz026/scistudio-package-lcms/releases/download/ota-alpha/manifest.json"
    )
    assert repo == "jiazhenz026/scistudio-package-lcms"
